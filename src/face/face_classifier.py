...
# 数据参数
MODEL_DIR = '../../inception-v3-model/'  # inception-v3模型的文件夹
MODEL_FILE = 'classify_image_graph_def.pb'  # inception-v3模型文件名
CACHE_DIR = '../../image_dst/face_photos'  # 图像的特征向量保存地址
INPUT_DATA = '../../image/face'  # 图片数据文件夹
        ...
        for i in range(STEPS):
            ...
            if i % 10 == 0 or i + 1 == STEPS:
                validation_bottlenecks, validation_ground_truth = get_random_cached_bottlenecks(
                    sess, n_classes, image_lists, V_BATCH, 'validation',
                    jpeg_data_tensor, bottleneck_tensor)
                ...
                print(
                    ...
                    % (i, V_BATCH, validation_accuracy * 100))
